...
/* harmony import */ var _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_init_locomotive__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-locomotive */ "./js/modules/init-locomotive.js");
/* harmony import */ var _modules_init_scrollTrigger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-scrollTrigger */ "./js/modules/init-scrollTrigger.js");
/* harmony import */ var _modules_animations__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/animations */ "./js/modules/animations/index.js");
/* harmony import */ var _utils_observers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/observers */ "./js/utils/observers.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_3__["initFormValidate"])(); // scroll modules

    gsap.registerPlugin(_vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_4__["ScrollTrigger"]);
    Object(_modules_init_locomotive__WEBPACK_IMPORTED_MODULE_5__["initLocoScroll"])();
    Object(_modules_init_scrollTrigger__WEBPACK_IMPORTED_MODULE_6__["initScrollTriggerLs"])();
    Object(_utils_observers__WEBPACK_IMPORTED_MODULE_8__["initScrollObserver"])(); // -------------------

    Object(_modules_animations__WEBPACK_IMPORTED_MODULE_7__["initAnimations"])(); // loaded

    _utils_observers__WEBPACK_IMPORTED_MODULE_8__["resizeObserver"].fire('pageLoad');
  });
}); // ---------------------------------
...
/* harmony import */ var _utils_observers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/observers */ "./js/utils/observers.js");
...
var Cursor = /*#__PURE__*/function () {
  ...
  _createClass(Cursor, [{
    ...
    value: function handlerMouseMove(evt) {
      ...
      var btnCircle = this.evt.target.closest('[data-cursor-btn="circle"]');

      if (btnCircle) {
        var btnRect = btnCircle.getBoundingClientRect();
        var cursorRect = this.cursor.getBoundingClientRect();

        if (!this.circleBtnInView) {
          gsap.to(this.cursorContent, {
            scale: (btnRect.width / cursorRect.width).toFixed(2),
            duration: 0.4,
            ease: 'Power1.out'
          });
    ...
    key: "checkCursorType",
    value: function checkCursorType(cursorBox) {
    ...
    key: "updateDisplayOnMouseMove",
    value: function updateDisplayOnMouseMove(evt) {
      var cursorBox = evt.target.closest('[data-cursor-lazy]');
      ...
      this.cursor.classList.add('is-shown'); // TODO все что связанно со слайдером вынести в отдельный метод

      this.sliderInView = true;
      var boxRect = cursorBox.getBoundingClientRect();
      this.lastSliderRect = boxRect;
      var isLeft = {
        x: boxRect.width / 2 >= this.mouse.x - boxRect.left // y: boxRect.height
      ...
      var sliderWrapper = cursorBox.closest('.swiper-wrapper') || cursorBox.querySelector('.swiper-wrapper');
    ...
    key: "clickCursorAnimation",
    value: function clickCursorAnimation() {
      var _this = this;
    ...
    value: function removeListeners() {
      ...
      _utils_observers__WEBPACK_IMPORTED_MODULE_0__["scrollObserver"].unsubscribe(function () {
        return _this2.handlerMouseMove();
      });
    }
  }, {
    key: "setListeners",
    value: function setListeners() {
      ...
      _utils_observers__WEBPACK_IMPORTED_MODULE_0__["scrollObserver"].subscribe(function () {
        return _this3.handlerMouseMove();
      });
    }
  }, {
    key: "breakpointChecker",
    value: function breakpointChecker() {
...
/* harmony import */ var _cursor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cursor */ "./js/modules/animations/cursor.js");
/* harmony import */ var _steps_grid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./steps-grid */ "./js/modules/animations/steps-grid.js");
/* harmony import */ var _mouse_parallax__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mouse-parallax */ "./js/modules/animations/mouse-parallax.js");
/* harmony import */ var _wave_scroll_effects__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./wave-scroll-effects */ "./js/modules/animations/wave-scroll-effects.js");
/* harmony import */ var _slide_grid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./slide-grid */ "./js/modules/animations/slide-grid.js");
...
var initAnimations = function initAnimations() {
  new _steps_grid__WEBPACK_IMPORTED_MODULE_1__["StepsGrid"]();
  new _cursor__WEBPACK_IMPORTED_MODULE_0__["Cursor"]();
  Object(_mouse_parallax__WEBPACK_IMPORTED_MODULE_2__["initMouseSvgParallax"])();
  Object(_wave_scroll_effects__WEBPACK_IMPORTED_MODULE_3__["initWaveEffects"])();
  Object(_slide_grid__WEBPACK_IMPORTED_MODULE_4__["initSlideGrid"])();
};

/***/ }),

/***/ "./js/modules/animations/mouse-parallax.js":
/*!*************************************************!*\
  !*** ./js/modules/animations/mouse-parallax.js ***!
  \*************************************************/
/*! exports provided: initMouseSvgParallax */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMouseSvgParallax", function() { return initMouseSvgParallax; });
...
var initMouseSvgParallax = function initMouseSvgParallax() {
  var svg = document.querySelector('[data-mouse-parallax]');

  if (!svg) {
    return;
  }

  var layers = svg.querySelectorAll('path');
  ...
  function parallaxIt(target, movement, k) {
    var a = _toConsumableArray(target).reverse();
...
/***/ "./js/modules/animations/slide-grid.js":
/*!*********************************************!*\
  !*** ./js/modules/animations/slide-grid.js ***!
  \*********************************************/
/*! exports provided: initSlideGrid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSlideGrid", function() { return initSlideGrid; });
var initSlideGrid = function initSlideGrid() {
...
/***/ "./js/modules/animations/steps-grid.js":
/*!*********************************************!*\
  !*** ./js/modules/animations/steps-grid.js ***!
  \*********************************************/
/*! exports provided: StepsGrid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StepsGrid", function() { return StepsGrid; });
/* harmony import */ var _utils_observers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/observers */ "./js/utils/observers.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var StepsGrid = /*#__PURE__*/function () {
  function StepsGrid() {
    var _this = this;

    _classCallCheck(this, StepsGrid);
    ...
    _utils_observers__WEBPACK_IMPORTED_MODULE_0__["resizeObserver"].subscribe(function () {
      return _this.init();
    });
  }

  _createClass(StepsGrid, [{
    key: "init",
    value: function init() {
      this.initBoxRotate();
      this.initBoxDown();
    ...
    value: function initBoxRotate() {
      ...
      var startBoxRect = this.startBox.getBoundingClientRect();
      var rotateBoxRect = this.rotateBox.getBoundingClientRect();
    ...
    key: "initBoxDown",
    value: function initBoxDown() {
      var _this2 = this;

      if (this.tlBoxDown.length) {
        console.log('BoxDown reinit');
        this.tlBoxDown.forEach(function (tl) {
          tl.seek(0).kill();
          tl = null;
        });
        this.tlBoxDown = [];
        this.downBox.forEach(function (box) {
          return gsap.set(box, {
            clearProps: 'transform'
          });
        });
      ...
      this.tlBoxDown = []; // create timeline

      this.downBox.forEach(function (box, i) {
        ...
        var tl = gsap.timeline({
          ...
          scrollTrigger: {
            trigger: box,
            scroller: '[data-scroll-container]',
            start: "bottom ".concat(window.innerHeight / 2),
            end: 'bottom 0%',
            scrub: 0
          }
        });
        var nextBoxRect = i === _this2.downBox.length - 1 ? document.querySelector('[data-step-box="down-last"]').getBoundingClientRect() : _this2.downBox[i + 1].getBoundingClientRect();
        var yOffset = nextBoxRect.bottom - boxRect.bottom;
        tl.to(box, {
          y: yOffset
        });

        _this2.tlBoxDown.push(tl);
      });
    }
  }]);
...
/***/ "./js/modules/animations/wave-scroll-effects.js":
/*!******************************************************!*\
  !*** ./js/modules/animations/wave-scroll-effects.js ***!
  \******************************************************/
/*! exports provided: initWaveEffects */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initWaveEffects", function() { return initWaveEffects; });
/* harmony import */ var _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../vendor/ScrollTrigger */ "./js/vendor/ScrollTrigger.js");
/* harmony import */ var _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__);
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var textWaveEffect = function textWaveEffect() {
  var chars = _toConsumableArray(document.querySelectorAll(".section__center-title .char"));

  _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0___default.a.create({
    scroller: '[data-scroll-container]',
    trigger: "[data-splitting='wave']",
    start: "top bottom",
    end: "bottom top",
    onUpdate: function onUpdate(self) {
      var velocity = self.getVelocity(); // добавить тамаут, по которому буквы вернутся в исходное положение

      chars.forEach(function (char, i) {
        var charCoefficient = i + 1 - chars.length / 2;
        gsap.to(char, {
...
var bgWaveEffect = function bgWaveEffect() {
  _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0___default.a.create({
    scroller: '[data-scroll-container]',
...
var initWaveEffects = function initWaveEffects() {
  bgWaveEffect();
  textWaveEffect();
};
...
/*!***************************************!*\
  !*** ./js/modules/init-locomotive.js ***!
  \***************************************/
/*! exports provided: initLocoScroll, updateLocomotiveScroll, scroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initLocoScroll", function() { return initLocoScroll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateLocomotiveScroll", function() { return updateLocomotiveScroll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scroll", function() { return scroll; });
/* harmony import */ var _vendor_LocomotiveScroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../vendor/LocomotiveScroll */ "./js/vendor/LocomotiveScroll.js");

var scroll;

var initLocoScroll = function initLocoScroll() {
...
var updateLocomotiveScroll = function updateLocomotiveScroll() {
  scroll.update();
};
...
/***/ "./js/modules/init-scrollTrigger.js":
/*!******************************************!*\
  !*** ./js/modules/init-scrollTrigger.js ***!
  \******************************************/
/*! exports provided: initScrollTriggerLs, scrollTrigger */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initScrollTriggerLs", function() { return initScrollTriggerLs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollTrigger", function() { return scrollTrigger; });
/* harmony import */ var _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../vendor/ScrollTrigger */ "./js/vendor/ScrollTrigger.js");
/* harmony import */ var _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _init_locomotive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./init-locomotive */ "./js/modules/init-locomotive.js");


var scrollTrigger;

var initScrollTriggerLs = function initScrollTriggerLs() {
  gsap.registerPlugin(_vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__["ScrollTrigger"]); // each time Locomotive Scroll updates, tell ScrollTrigger to update too (sync positioning)

  _init_locomotive__WEBPACK_IMPORTED_MODULE_1__["scroll"].on('scroll', _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__["ScrollTrigger"].update); // tell ScrollTrigger to use these proxy methods for the '.smooth-scroll' element since Locomotive Scroll is hijacking things

  _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__["ScrollTrigger"].scrollerProxy('[data-scroll-container]', {
    scrollTop: function scrollTop(value) {
      return arguments.length ? _init_locomotive__WEBPACK_IMPORTED_MODULE_1__["scroll"].scrollTo(value, 0, 0) : _init_locomotive__WEBPACK_IMPORTED_MODULE_1__["scroll"].scroll.instance.scroll.y;
    },
  ...
  _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__["ScrollTrigger"].addEventListener('refresh', function () {
    return _init_locomotive__WEBPACK_IMPORTED_MODULE_1__["scroll"].update();
  }); // after everything is set up, refresh() ScrollTrigger and update LocomotiveScroll because padding may have been added for pinning, etc.

  _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__["ScrollTrigger"].refresh();
  window.addEventListener('scrolltrigger.update', function () {
    _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__["ScrollTrigger"].refresh();
  });
  scrollTrigger = _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__["ScrollTrigger"];
  window.scrollTrigger = _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_0__["ScrollTrigger"];
};
...
/*!*******************************!*\
  !*** ./js/utils/observers.js ***!
  \*******************************/
/*! exports provided: resizeObserver, clickObserver, initScrollObserver, scrollObserver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _modules_init_scrollTrigger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/init-scrollTrigger */ "./js/modules/init-scrollTrigger.js");
/* harmony import */ var _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../vendor/ScrollTrigger */ "./js/vendor/ScrollTrigger.js");
/* harmony import */ var _vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var locoScroll = function locoScroll() {
...
/* harmony default export */ __webpack_exports__["default"] = (locoScroll());
